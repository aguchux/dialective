...
| P2P token market | `/dashboard?view=market` | Signed-in trainer; feature may be disabled |
| My Scores | `/dashboard?view=scores` | Signed-in trainer |
| Profile, country, dialect, phone, payment methods, and notifications | `/dashboard?view=profile` | Signed-in trainer |
| Referrals | `/dashboard?view=referrals` | Signed-in trainer |
...
| Distributor market | `/distributor/market` | Signed-in distributor; feature may be disabled |
