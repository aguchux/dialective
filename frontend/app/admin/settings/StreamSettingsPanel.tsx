    ...
    <section className="grid gap-4 rounded-lg border border-line bg-white p-5 shadow-[0_2px_8px_rgba(27,31,27,0.05)]">
      <div className="grid gap-1">
        ...
        <p className="leading-relaxed text-muted">
          ...
          licensing app), separate from the trainer platform's own settings elsewhere on this page.
        </p>
      </div>
            ...
            >
              ...
              <span>
                ...
                <span className="mt-1 block text-sm leading-relaxed text-muted">
                  ...
                  first. When off (default), Stream stays admin-invite-only and /register only
                  collects a &quot;Request access&quot; lead for admin follow-up -- from there, use
                  Approve &amp; invite or Resend invite on the{' '}
                  <a
