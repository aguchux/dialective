      ...
      <div className="grid gap-6">
        <div className="grid gap-2">
          ...
          <p className="leading-relaxed text-muted">
            ...
            the original hand-seeded bank. Delete a word or deactivate a prompt to remove it from
            the trainer-facing pool.
          </p>
        </div>
  ...
  return (
    <section className="grid gap-4 overflow-hidden rounded-lg border border-line bg-white shadow-[0_2px_8px_rgba(27,31,27,0.05)]">
      ...
      {isLoading ? (
        ...
        <p className="p-5 text-muted">
          {debouncedSearch ? `No prompts match "${debouncedSearch}".` : 'No prompts yet.'}
        </p>
      )}
