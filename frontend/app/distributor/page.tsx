        ...
        {data && (
          <>
            <section className="grid gap-5 border-b border-white/10 pb-6 md:grid-cols-[1fr_auto] md:items-end">
              ...
              <button
                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border border-white/15 px-3 font-extrabold text-white hover:bg-white/10"
                onClick={() => refetch()}
                type="button"
              >
            ...
            <a
              className="inline-flex min-h-11 w-fit items-center justify-center gap-2 rounded-lg bg-[#7b1ec9] px-4 font-extrabold text-white no-underline hover:bg-[#8e35dc]"
