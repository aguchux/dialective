...
export const metadata = {
  title: 'Blog',
  description:
    'Updates from Dialect Library on voice AI, language data, contributors, and underrepresented dialects.',
};
      ...
      <div className="relative z-10 mx-auto grid max-w-5xl gap-8 px-4 py-6 md:px-8">
        ...
        <header className="grid gap-3 border-b border-line pb-7">
          ...
          <h1 className="max-w-3xl text-4xl font-black leading-tight md:text-5xl">
            Ideas, progress, and field notes
          </h1>
          <p className="max-w-2xl text-lg leading-relaxed text-muted">
            Updates on the platform, the trainer program, and building voice AI for underrepresented
            dialects.
          </p>
        </header>
        <section className="grid gap-6 md:grid-cols-2" aria-label="Blog posts">
          ...
          {posts.length === 0 && (
            <p className="py-12 text-muted">No articles have been published yet.</p>
          )}
        </section>
      </div>
