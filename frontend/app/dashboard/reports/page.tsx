...
export default function TrainerReportsPage() {
  ...
  return (
    <div className="mx-auto grid min-h-screen max-w-4xl content-start gap-6 px-4 py-8 md:px-6">
      <style>{`
        @media print {
      ...
      {data && totals && (
        <div className="grid gap-6" ref={reportRef}>
          <h2 className="hidden text-2xl font-black print:block">Dialect Library -- Your report</h2>
