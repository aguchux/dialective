            ...
            <div className="grid gap-6" ref={reportRef}>
              ...
              <section className="grid gap-2">
                ...
                >
                  ...
                  <StatCard
                    label="Other credits"
                    value={formatCompactTokens(totals.otherCreditsTokens)}
                  />
                  <StatCard
                ...
                <p className="text-xs text-muted">
                  Tokens earned covers training payouts, course rewards, referral bonuses, and
                  testimonials. Other credits covers funding added by an admin or a deposit -- not
                  earned through tasks, but still added to your balance. Task locks and refunds are
                  temporary holds during a task and aren't counted in either figure.
                </p>
              </section>
