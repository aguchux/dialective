...
class StreamConsumer:
    ...
    services/vosk-worker/streams.py exactly (and
    services/*/src/redis-streams/redis-streams.service.ts on the Node
    side) so the pattern is consistent across every worker.
    """
