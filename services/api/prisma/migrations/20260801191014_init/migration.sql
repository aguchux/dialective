-- CreateEnum
CREATE TYPE "Role" AS ENUM ('TRAINER', 'ADMIN');

-- CreateEnum
CREATE TYPE "AuthProvider" AS ENUM ('CREDENTIALS', 'GOOGLE', 'EMAIL');
...
-- CreateIndex
CREATE UNIQUE INDEX "linked_accounts_provider_providerAccountId_key" ON "linked_accounts"("provider", "providerAccountId");
